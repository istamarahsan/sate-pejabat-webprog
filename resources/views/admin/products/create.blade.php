...
@section('child-content')
    <div class="mx-2 my-2 flex flex-col items-start">
        ...
        <h1 class="text-3xl my-4 font-black flex flex-grow w-full items-baseline">Add New Product</h1>
        <form method="post" action="{{ route('admin.products.store') }}">
            ...
            <div class="form-control w-full max-w-xs">
                ...
                <input autocomplete="off" type="text" id="name" name="name" placeholder="Name" class="input input-bordered w-full max-w-xs" required />
            </div>
            <div class="form-control w-full max-w-xs">
                <label class="label">
                    <span class="label-text">Price</span>
                </label>
                <input autocomplete="off" type="number" id="price" name="price" placeholder="0" class="input input-bordered w-full max-w-xs none" required />
            </div>
            <label class="label">
