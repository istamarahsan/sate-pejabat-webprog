...
<div class="flex flex-grow">
  <div class="border border-zinc-800 border-y-0 border-l-0 flex flex-col">
    ...
    <div class="flex flex-col">
      <a href="managestaff" class="py-3 px-5 mt-2 w-full transition-colors duration-200 text-left text-sm font-semibold text-zinc-100 {{ Request::is('admin/*/manage-staff') ? "bg-zinc-800 hover:bg-zinc-600" : "hover:bg-zinc-800" }}">
        Staffs
      </a>
